...
const Navbar = () => {
    ...
    const links = <>
        <li className="border rounded-lg"><NavLink to='/'>Home</NavLink></li>
        <li className="border rounded-lg"><NavLink to='/departments'>Departments</NavLink></li>
        <li className="border rounded-lg"><NavLink to='/gallery'>Gallery</NavLink></li>
        <li className="border rounded-lg"><NavLink to='/about-us'>About US</NavLink></li>
    </>
